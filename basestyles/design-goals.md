...
<div class="ui-box mb-6">

### UI Elements *Plus* Code Organization

Most CSS libraries give you *either*: 1. A set of patterns for keeping things organized (E.g. [Tailwind](https://tailwindcss.com/)), __or__ 2. A set of UI elements (E.g. [Shadcn](https://ui.shadcn.com/)). We wanted something that gave us both.
...
> **We would love to see authors build libraries for their specific framework __on top of__ Base Styles. If you are interested in this, please go right ahead!**
