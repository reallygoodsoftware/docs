...
<div class="ui-box ui-sandbox my-6">
...
<div class="ui-box ui-sandbox not-prose my-6 ui-styled-text-unset">
...
<form id="form1" class="ui-box ui-sandbox my-6 ui-form" action="/docs">
