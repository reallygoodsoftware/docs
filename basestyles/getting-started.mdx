...
<Steps>
  <Step title="Add Base Styles to your project" titleSize="h2">
    <a target="_blank" href="https://raw.githubusercontent.com/reallygoodsoftware/base-styles/refs/heads/main/base-styles.css" download="base-styles.css">Download base-styles.css</a>
  </Step>
