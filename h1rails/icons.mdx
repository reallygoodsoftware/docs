...
H1 Rails comes pre-loaded with both [heroicons](https://heroicons.com/) and [tabler](https://tablericons.com/) icons, which are free to use, look great, and cover most use cases. We use the [inline\_svg](https://github.com/jamesmartin/inline_svg) gem to render them.
