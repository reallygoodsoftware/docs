...
<Tabs>
  ...
  <Tab title="Icons">
    * Pre loaded icons from [Heroicons](https://heroicons.com) and [Tabler Icons](https://tabler.io/icons)

    * Add classes to style icons using [inline\_svg](https://github.com/jamesmartin/inline_svg).

    [Read More about Icons →](/h1rails/icons)
  </Tab>
